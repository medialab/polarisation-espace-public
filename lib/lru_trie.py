...
class LRUTrie(object):
    ...
    @staticmethod
    def from_csv(filename, urlfield='url', urlseparator=None, namefield='name', detailed=False, filterrows=None):
        trie = LRUTrie()
        ...
        with open(filename, 'r') as f:
            ...
            for line in reader:
                ...
                if urlseparator:
                    ...
                    trie.set(line[urlfield], line[namefield] if not detailed else line)
