...
def extract_users_urls_medias_from_csv(f, trie, of=sys.stdout, total=None):
    ...
    try:
        for row, (tid, uname, uid, dtime, rtid, nbfols, links) in tqdm(enumerate(
...
if __name__ == "__main__":
    ...
    with open_wrapper(source) as f:
        ...
        extract_users_urls_medias_from_csv(f, trie, total=csv_lines)
